...
background-repeat: no-repeat;\
	...
	asc_docs_api.prototype.asc_PasteData = function(_format, data1, data2, text_data, useCurrentPoint, callback, checkLocks, rejectCallback, bookmarkStart, bookmarkEnd, pasteFormatting)
	{
		if (AscCommon.CollaborativeEditing.Get_GlobalLock())
			return;
		...
		else
		{
			...
			AscCommon.Editor_Paste_Exec(this, _format, data1, data2, text_data, undefined, callback, rejectCallback, bookmarkStart, bookmarkEnd, pasteFormatting);
		}
	};
